...
def load_and_preprocess(mri_file):
    images = {}
    # t1
    images["T1"] = sitkUtils.PullVolumeFromSlicer(util.getNode(mri_file))
    ...
    print("====================================")
    print("Original Size: ", images["T1"].GetSize())
...
def save_segmentation_nifti(segmentation, dct, keep_mask, out_fname, mask_fname=None, order=1):
    '''
    ...
    sitkUtils.PushVolumeToSlicer(seg_resized_itk, name=mask_fname)
